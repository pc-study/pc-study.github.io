---
title: 《零基础安装 Oracle 数据库》RAC集群系列 ❺ 简单两步快速安装 Oracle 21C RAC 数据库
date: 2021-08-23 12:42:17
tags: [oracle安装,玩转 vagrant]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/101986
---
...
下载好之后，将 Oracle 安装包拷贝到项目中的 `rac_db/software/21300` 目录下。
