---
title: 华为欧拉 openEuler 22.03 LTS SP3 一键安装 Oracle 21C 单机
date: 2024-05-24 16:55:23
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793928644552888320
---

# 前言

Oracle 一键安装脚本，演示 openEuler 22.03 LTS SP3 一键安装 Oracle 21C 单机过程（全程无需人工干预）。
...
-rwx------. 1 root root 3109225519 Mar 27 17:05 LINUX.X64_213000_db_home.zip
-rwxr-xr-x. 1 root root     195976 Mar 27 17:03 OracleShellInstall
-rwx------. 1 root root 1458473664 Mar 27 17:04 p36352352_210000_Linux-x86-64.zip
-rwx------. 1 root root  127629034 Mar 27 17:03 p6880880_210000_Linux-x86-64.zip
-rwx------. 1 root root     321590 Mar 20 15:22 rlwrap-0.44.tar.gz
```
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240327171118.log）                                                                                  
...
正在安装依赖包......已完成 (耗时: 422 秒)
正在配置主机名和 /etc/hosts......已完成 (耗时: 0 秒)
正在创建用户和组......已完成 (耗时: 18 秒)
正在创建安装目录......已完成 (耗时: 1 秒)
...
正在安装 rlwrap 插件......已完成 (耗时: 31 秒)
正在配置用户环境变量......已完成 (耗时: 1 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 252 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 2283 秒)
正在创建监听......已完成 (耗时: 15 秒)
正在创建数据库......已完成 (耗时: 2107 秒)
正在优化数据库......已完成 (耗时: 41 秒)

恭喜！Oracle 单机安装成功 (耗时: 5187 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 21.0.0.0.0 - Production on Mon Apr 22 11:14:02 2024
Version 21.14.0.0.0
...
sys@LUCIFER 2024-04-22 11:14:02> show parameter name
