---
title: 《零基础安装 Oracle 数据库》单机ASM系列 3️⃣ 一键快速安装 Oracle 18C 数据库
date: 2021-08-22 02:08:22
tags: [oracle安装,玩转 vagrant]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/101863
---
...
下载好之后，将 Oracle 安装包拷贝到项目中的 `singleasm_db/software/18000` 目录下。

![](https://oss-emcsprod-public.modb.pro/image/editor/20210822-35ca9ff8-872c-4638-9776-71a3bb612d38.png)

<font color='red'>**📢 注意：**</font> 项目 `singleasm_db/software/18000` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 <font color='red'>**失败**</font>！
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20210822-4ba57cce-2f9b-4e70-b53f-fd4d2684c0d2.png)
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20210822-5c14e72b-27cb-425e-9376-4ab2ae4ccd19.png)
