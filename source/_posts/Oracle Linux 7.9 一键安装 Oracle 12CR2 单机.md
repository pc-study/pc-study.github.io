---
title: Oracle Linux 7.9 一键安装 Oracle 12CR2 单机
date: 2024-05-24 15:59:16
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793914562089127936
---

# 前言

Oracle 一键安装脚本，演示 Oracle Linux 7.9 一键安装 Oracle 12CR2 单机（240116）过程（全程无需人工干预）。
...
# 安装包存放在 /soft 目录下
[root@oel7 soft]# ll
-rwx------. 1 root root 3453696911 Apr 17 13:34 LINUX.X64_122010_db_home.zip
-rwxr-xr-x. 1 root root     195177 Apr 17 13:33 OracleShellInstall
-rwx------. 1 root root  138325588 Apr 17 13:34 p35926712_122010_Linux-x86-64.zip
-rwx------. 1 root root 1148325873 Apr 17 13:34 p35966787_122010_Linux-x86-64.zip
-rwx------. 1 root root  127629034 Apr 17 13:33 p6880880_122010_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240417134200.log）                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1414 秒)
正在创建监听......已完成 (耗时: 7 秒)
正在创建数据库......已完成 (耗时: 762 秒)
正在优化数据库......已完成 (耗时: 14 秒)

恭喜！Oracle 单机安装成功 (耗时: 2399 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 12.2.0.1.0 Production on Wed Apr 17 14:28:28 2024
...
sys@LUCIFER 2024-04-17 14:28:29> show parameter name
