---
title: Oracle Linux 8.9 一键安装 Oracle 21C 单机
date: 2024-05-24 17:26:54
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793936618667184128
---

# 前言

Oracle 一键安装脚本，演示 Oracle Linux 8.9 一键安装 Oracle 21C 单机过程（全程无需人工干预）。
...
# 安装包存放在 /soft 目录下
[root@oel soft]# ll
-rwx------. 1 root root 2032560000 Apr 24 13:38 LINUX.X64_213000_db_home.zip
-rwxr-xr-x. 1 root root     197339 Apr 24 13:37 OracleShellInstall
-rwx------. 1 root root 1458473664 Apr 24 13:38 p36352352_210000_Linux-x86-64.zip
-rwx------. 1 root root  127629034 Apr 24 13:37 p6880880_210000_Linux-x86-64.zip
...
OracleShellInstall 开始安装，安装过程可查看日志： /soft/print_ora_install_20240424133830.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1378 秒)
正在创建监听......已完成 (耗时: 3 秒)
正在创建数据库......已完成 (耗时: 1395 秒)
正在优化数据库......已完成 (耗时: 33 秒)

恭喜！Oracle 单机安装成功 (耗时: 3102 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 21.0.0.0.0 - Production on 24-APR-2024 14:37:48
...
Start Date                24-APR-2024 14:35:32
...
Services Summary...
Service "16d2c977ec0929e6e063b506a8c0151e" has 1 instance(s).
...
SQL*Plus: Release 21.0.0.0.0 - Production on Wed Apr 24 14:37:13 2024
Version 21.14.0.0.0
...
sys@LUCIFER 2024-04-24 14:37:13> show parameter name
...
sys@LUCIFER 2024-04-24 14:37:58> show pdbs
