---
title: 华为欧拉 openEuler 22.03 LTS SP3 一键安装 Oracle 21C RAC
date: 2024-05-24 16:57:06
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793929070127943680
---
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240329151817.log
...
正在配置 RAC 其他节点信息......已完成 (耗时: 315 秒)
正在配置 RAC 所有节点互信......已完成 (耗时: 13 秒)
正在解压 Grid 安装包以及补丁......已完成 (耗时: 228 秒)
正在解压 Oracle 软件以及补丁......已完成 (耗时: 161 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 3165 秒)
正在创建 ASM 磁盘组......已完成 (耗时: 60 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 2293 秒)
正在创建数据库......已完成 (耗时: 1923 秒)
正在优化数据库......已完成 (耗时: 160 秒)

恭喜！Oracle RAC 安装成功 (耗时: 8588 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 21.0.0.0.0 - Production on Wed May 8 15:30:22 2024
Version 21.14.0.0.0
...
sys@LUCIFER 2024-05-08 15:30:23> show parameter name
...
sys@LUCIFER 2024-05-08 15:30:30> select instance_name,status from gv$instance;
