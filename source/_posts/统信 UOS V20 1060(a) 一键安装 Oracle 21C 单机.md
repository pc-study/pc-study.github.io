---
title: 统信 UOS V20 1060(a) 一键安装 Oracle 21C 单机
date: 2024-05-24 15:46:34
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793911355459325952
---

# 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1060(a) 一键安装 Oracle 21C 单机（全程无需人工干预）。
...
[root@uosv20 ~]# cd /soft/
[root@uosv20 soft]# ll
-rwx------ 1 root root 3059705302  3月 28 18:07 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     195976  3月 28 18:15 OracleShellInstall
-rwx------ 1 root root  127475677  3月 28 18:06 p36199232_190000_Linux-x86-64.zip
-rwx------ 1 root root 1856311021  3月 28 18:06 p36233263_190000_Linux-x86-64.zip
-rwx------ 1 root root  133535622  3月 28 18:06 p6880880_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240328181829.log）                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 157 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1855 秒)
正在创建监听......已完成 (耗时: 15 秒)
正在创建数据库......已完成 (耗时: 1443 秒)
正在优化数据库......已完成 (耗时: 40 秒)

恭喜！Oracle 单机安装成功 (耗时: 3635 秒)，现在是否重启主机：[Y/N] Y
...
```bash
[oracle@uosv20:/home/oracle]$ sqlplus -v

SQL*Plus: Release 21.0.0.0.0 - Production
Version 21.14.0.0.0

[oracle@uosv20:/home/oracle]$ opatch lspatches
...
```bash
[oracle@uosv20:/home/oracle]$ sas

SQL*Plus: Release 21.0.0.0.0 - Production on Mon Apr 22 13:59:14 2024
Version 21.14.0.0.0
...
sys@LUCIFER 2024-04-22 13:59:14> show parameter name
