---
title: Oracle Linux 7.9 一键安装 Oracle 19C 单机（19.22）
date: 2024-04-24 15:49:59
tags: [oracle,linux系统,string,root,oracle数据库]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1783040588504977408
---

# 前言
Oracle 一键安装脚本，演示 Oracle Linux 7.9 一键安装 Oracle 19C 单机（19.22）过程（全程无需人工干预）。**（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
# 安装包存放在 /soft 目录下
[root@oel7 soft]# ll
-rwx------. 1 root root 3059705302 Apr 17 14:34 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root     195165 Apr 17 14:32 OracleShellInstall
-rwx------. 1 root root  127451050 Apr 17 14:33 p35926646_190000_Linux-x86-64.zip
-rwx------. 1 root root 1817908992 Apr 17 14:33 p35943157_190000_Linux-x86-64.zip
-rwx------. 1 root root  127774864 Apr 17 14:33 p6880880_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240417143826.log）                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 336 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1793 秒)
正在创建监听......已完成 (耗时: 6 秒)
正在创建数据库......已完成 (耗时: 2024 秒)
正在优化数据库......已完成 (耗时: 24 秒)
...
SQL*Plus: Release 19.0.0.0.0 - Production on Wed Apr 17 16:05:52 2024
Version 19.22.0.0.0
...
sys@LUCIFER 2024-04-17 16:05:52> show parameter name
