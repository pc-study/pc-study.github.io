---
title: Debian 12.5 一键安装 Oracle 11GR2 单机
date: 2024-06-05 15:35:46
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1798254412749164544
---

# 前言
Oracle 一键安装脚本，演示华为 Debian 12.5 一键安装 Oracle 11GR2 单机版过程（全程无需人工干预）。
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240605150105.log                                                                                  

正在去除密码复杂度配置......已完成 (耗时: 0 秒)
正在配置软件源......已完成 (耗时: 22 秒)
正在获取操作系统信息......已完成 (耗时: 1 秒)
正在安装依赖包......已完成 (耗时: 137 秒)
正在配置 Swap......已完成 (耗时: 72 秒)
正在配置防火墙......已完成 (耗时: 2 秒)
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 46 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 209 秒)
正在创建监听......已完成 (耗时: 8 秒)
正在创建数据库......已完成 (耗时: 190 秒)
正在优化数据库......已完成 (耗时: 17 秒)

恭喜！Oracle 单机安装成功 (耗时: 734 秒)，现在是否重启主机：[Y/N] Y
...
Start Date                05-JUN-2024 15:20:29
...
sys@LUCIFER 2024-06-05 15:22:46> show parameter name
