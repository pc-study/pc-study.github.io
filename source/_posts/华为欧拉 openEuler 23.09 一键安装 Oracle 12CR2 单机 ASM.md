---
title: 华为欧拉 openEuler 23.09 一键安装 Oracle 12CR2 单机 ASM
date: 2024-06-02 21:05:23
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1797253140105990144
---

# 前言
Oracle 一键安装脚本，演示 openEuler 23.09 一键安装 Oracle 12CR2 单机 ASM 过程（全程无需人工干预）。
...
-rwx------. 1 root root 3453696911 May  8 13:48 LINUX.X64_122010_db_home.zip
-rwx------. 1 root root 2994687209 May  8 13:48 LINUX.X64_122010_grid_home.zip
-rwxr-xr-x. 1 root root     204495 May  8 13:46 OracleShellInstall
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240508134841.log                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 83 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 75 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 323 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 314 秒)
正在创建数据库......已完成 (耗时: 395 秒)
正在优化数据库......已完成 (耗时: 124 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 1393 秒)，现在是否重启主机：[Y/N] Y
...
There are no Interim patches installed in this Oracle Home "/u01/app/oracle/product/12.2.0/db".
...
SQL*Plus: Release 12.2.0.1.0 Production on Wed May 8 14:17:15 2024
...
sys@LUCIFER 2024-05-08 14:17:16> show parameter name
