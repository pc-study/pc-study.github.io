---
title: openEuler 23.09（华为欧拉）一键安装 Oracle 19C（19.23）单机版
date: 2024-05-08 16:53:32
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1788099172318646272
---

# 前言
Oracle 一键安装脚本，演示 openEuler 23.09 一键安装 Oracle 19C 单机（19.23）过程（全程无需人工干预）。**（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
-rwx------. 1 root root 454980000 May  8 13:40 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root    201856 May  8 13:33 OracleShellInstall
-rwx------. 1 root root 127475677 May  8 13:40 p36199232_190000_Linux-x86-64.zip
-rwx------. 1 root root 259740000 May  8 13:40 p36233263_190000_Linux-x86-64.zip
-rwx------. 1 root root 133535622 May  8 13:40 p6880880_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240508134330.log
...
正在安装 rlwrap 插件......已完成 (耗时: 27 秒)
正在配置用户环境变量......已完成 (耗时: 1 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 317 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 2818 秒)
正在创建监听......已完成 (耗时: 6 秒)
正在创建数据库......已完成 (耗时: 1689 秒)
正在优化数据库......已完成 (耗时: 26 秒)

恭喜！Oracle 单机安装成功 (耗时: 5046 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 08-MAY-2024 15:11:13
...
Start Date                08-MAY-2024 15:09:31
...
SQL*Plus: Release 19.0.0.0.0 - Production on Wed May 8 15:11:23 2024
Version 19.23.0.0.0
...
sys@LUCIFER 2024-05-08 15:11:23> show parameter name
