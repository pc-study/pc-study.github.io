---
title: RedHat 7.9 一键安装 Oracle 21C 单机 ASM
date: 2024-05-24 16:45:52
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793926285512232960
---

# 前言

Oracle 一键安装脚本，演示 RedHat 7.9 一键安装 Oracle 21C 单机 ASM（21.14）过程（全程无需人工干预）。
...
# 安装包存放在 /soft 目录下
[root@rac soft]# ll
-rwx------. 1 root root 3109225519 Apr 28 10:54 LINUX.X64_213000_db_home.zip
-rwx------. 1 root root 2422217613 Apr 28 10:54 LINUX.X64_213000_grid_home.zip
-rwxr-xr-x. 1 root root     199185 Apr 28 10:57 OracleShellInstall
-rwx------. 1 root root 2044000163 Apr 28 10:54 p36352207_210000_Linux-x86-64.zip
-rwx------. 1 root root  127629034 Apr 28 10:53 p6880880_210000_Linux-x86-64.zip
...
OracleShellInstall 开始安装，安装过程可查看日志： /soft/print_ora_install_20240428105845.log                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 177 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 152 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1031 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 780 秒)
正在创建数据库......已完成 (耗时: 1301 秒)
正在优化数据库......已完成 (耗时: 71 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 3624 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 21.0.0.0.0 - Production on Sun Apr 28 12:26:36 2024
Version 21.14.0.0.0
...
sys@LUCIFER 2024-04-28 12:26:37> show parameter name
...
sys@LUCIFER 2024-04-28 12:26:42> show pdbs
