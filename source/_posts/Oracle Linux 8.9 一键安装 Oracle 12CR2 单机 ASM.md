---
title: Oracle Linux 8.9 一键安装 Oracle 12CR2 单机 ASM
date: 2024-05-24 17:23:43
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793935871946346496
---

# 前言

Oracle 一键安装脚本，演示 Oracle Linux 8.9 一键安装 Oracle 12CR2 单机 ASM （231017）过程（全程无需人工干预）。
...
-rwxr-xr-x. 1 root root     195976 Apr 22 12:14 OracleShellInstall
-rwx------. 1 root root 2526745297 Apr 22 12:13 p35745595_122010_Linux-x86-64.zip
-rwx------. 1 root root  138325588 Apr 22 12:13 p35926712_122010_Linux-x86-64.zip
-rwx------. 1 root root  127629034 Apr 22 12:13 p6880880_122010_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240422121508.log）                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 292 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 97 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1573 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 2324 秒)
正在创建数据库......已完成 (耗时: 1059 秒)
正在优化数据库......已完成 (耗时: 134 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 5631 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 12.2.0.1.0 Production on Mon Apr 22 14:01:33 2024
...
sys@LUCIFER 2024-04-22 14:01:34> show parameter name
