---
title: 阿里龙蜥 Anolis 7.9  一键安装 Oracle 11GR2 单机 ASM
date: 2024-05-24 17:03:47
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793930803591843840
---

# 前言

Oracle 一键安装脚本，演示龙蜥 Anolis 7.9 一键安装 Oracle 11GR2 单机 ASM（231017）过程（全程无需人工干预）。
...
-rwxr-xr-x 1 root root     200397 Apr 30 13:17 OracleShellInstall
...
-rwx------ 1 root root 1205251894 Apr 30 13:17 p13390677_112040_Linux-x86-64_3of7.zip
-rwx------ 1 root root  174911877 Apr 30 13:17 p18370031_112040_Linux-x86-64.zip
-rwx------ 1 root root   86183099 Apr 30 13:18 p35685663_112040_Linux-x86-64.zip
-rwx------ 1 root root 1491006593 Apr 30 13:18 p35685688_112040_Linux-x86-64.zip
-rwx------ 1 root root  128433424 Apr 30 13:18 p6880880_112000_Linux-x86-64.zip
...
OracleShellInstall 开始安装，安装过程可查看日志： /soft/print_ora_install_20240430153612.log                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 1 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 1 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1131 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1085 秒)
正在创建数据库......已完成 (耗时: 861 秒)
恭喜！Oracle 单机 ASM 安装成功 (耗时: 3120 秒)，现在是否重启主机：[Y/N] Y
...
--------------------------------------------------------------------------------
ora.DATA.dg
               ONLINE  ONLINE       anolis7                                      
ora.LISTENER.lsnr
               ONLINE  ONLINE       anolis7                                      
ora.asm
               ONLINE  ONLINE       anolis7                  Started             
ora.ons
               OFFLINE OFFLINE      anolis7                                      
--------------------------------------------------------------------------------
Cluster Resources
--------------------------------------------------------------------------------
ora.cssd
      1        ONLINE  ONLINE       anolis7                                      
ora.diskmon
      1        OFFLINE OFFLINE                                                   
ora.evmd
      1        ONLINE  ONLINE       anolis7                                      
ora.lucifer.db
      1        ONLINE  ONLINE       anolis7                  Open       
```
...
SQL*Plus: Release 11.2.0.4.0 Production on Tue Apr 30 16:41:51 2024
...
sys@LUCIFER 2024-04-30 16:41:52> show parameter name
