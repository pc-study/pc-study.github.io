---
title: Ubuntu 24.04 一键安装 Oracle 11GR2 单机
date: 2024-10-14 14:48:35
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1845718325990617088
---

>大家好，这里是 **Lucifer三思而后行**，专注于提升数据库运维效率。

## 前言
Oracle 一键安装脚本，演示 Ubuntu 24.04 一键安装 Oracle 11GR2 单机（全程无需人工干预）。
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240730171552.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 258 秒)
正在创建监听......已完成 (耗时: 5 秒)
正在创建数据库......已完成 (耗时: 235 秒)
正在优化数据库......已完成 (耗时: 15 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 722 秒)，现在是否重启主机：[Y/N] Y
