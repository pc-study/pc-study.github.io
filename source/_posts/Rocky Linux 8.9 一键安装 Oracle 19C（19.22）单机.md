---
title: Rocky Linux 8.9 一键安装 Oracle 19C（19.22）单机
date: 2024-04-24 15:08:11
tags: [oracle,rocky,linux系统,string,root]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1783030084206661632
---

# 前言
Oracle 一键安装脚本，演示 Rocky Linux 8.9 一键安装 Oracle 19C 单机（全程无需人工干预）。**（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
# 安装包存放在 /soft 目录下
[root@rocky8 soft]# ll
-rwx------. 1 root root 3059705302 Apr 10 12:46 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root     191021 Apr 10 11:12 OracleShellInstall
-rwx------. 1 root root  127451050 Apr 10 12:46 p35926646_190000_Linux-x86-64.zip
-rwx------. 1 root root 1817908992 Apr 10 12:46 p35943157_190000_Linux-x86-64.zip
-rwx------. 1 root root  127774864 Apr 10 12:46 p6880880_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240410125831.log）                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1539 秒)
正在创建监听......已完成 (耗时: 6 秒)
正在创建数据库......已完成 (耗时: 1926 秒)
正在优化数据库......已完成 (耗时: 62 秒)

恭喜！Oracle 单机安装成功 (耗时: 3759 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 19.0.0.0.0 - Production on Wed Apr 10 14:21:20 2024
Version 19.22.0.0.0
...
sys@LUCIFER 2024-04-10 14:21:21> show parameter name
