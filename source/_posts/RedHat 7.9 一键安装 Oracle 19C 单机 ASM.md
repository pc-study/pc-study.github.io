---
title: RedHat 7.9 一键安装 Oracle 19C 单机 ASM
date: 2024-05-24 16:11:01
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793917518913556480
---

# 前言

Oracle 一键安装脚本，演示 RedHat 7.9 一键安装 Oracle 19C 单机 ASM（19.23）过程（全程无需人工干预）。
...
OracleShellInstall 开始安装，安装过程可查看日志： /soft/print_ora_install_20240428092128.log                                                                                  
正在检查操作系统是否符合安装条件......已完成 (耗时: 0 秒)
正在去除密码复杂度配置......已完成 (耗时: 1 秒)
正在配置 YUM 源......已完成 (耗时: 1 秒)
正在获取操作系统信息......已完成 (耗时: 2 秒)
正在配置 Swap......已完成 (耗时: 28 秒)
正在配置防火墙......已完成 (耗时: 2 秒)
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 215 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 146 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1239 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1295 秒)
正在创建数据库......已完成 (耗时: 1696 秒)
正在优化数据库......已完成 (耗时: 137 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 4849 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 19.0.0.0.0 - Production on Sun Apr 28 10:47:23 2024
Version 19.23.0.0.0
...
sys@ORCL 2024-04-28 10:47:23> show parameter name
