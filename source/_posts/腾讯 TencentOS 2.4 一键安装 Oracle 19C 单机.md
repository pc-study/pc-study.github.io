---
title: 腾讯 TencentOS 2.4 一键安装 Oracle 19C 单机
date: 2024-10-12 13:30:02
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1844973698737078272
---
...
Oracle 一键安装脚本，演示腾讯 TencentOS 2.4 一键安装 Oracle 19C 单机过程（全程无需人工干预）。
...
-rwx------. 1 root root 3059705302 Sep 24 15:03 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root     243167 Sep 24 15:02 OracleShellInstall
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240924150502.log                                                                                  
...
正在创建监听......已完成 (耗时: 3 秒)
正在创建数据库......已完成 (耗时: 634 秒)
正在优化数据库......已完成 (耗时: 32 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 959 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 24-SEP-2024 16:12:34

Copyright (c) 1991, 2019, Oracle.  All rights reserved.

Connecting to (DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=tencent)(PORT=1521)))
STATUS of the LISTENER
------------------------
Alias                     LISTENER
Version                   TNSLSNR for Linux: Version 19.0.0.0.0 - Production
Start Date                24-SEP-2024 16:11:13
...
```bash
[oracle@tencent:/home/oracle]$ sas

SQL*Plus: Release 19.0.0.0.0 - Production on Tue Sep 24 16:12:46 2024
Version 19.3.0.0.0
