---
title: 龙蜥 Anolis OS 7.9 一键安装 Oracle 19C（19.23）单机版
date: 2024-03-27 12:36:54
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1772105823525900288
---

# 前言
**Oracle 一键安装脚本，演示 龙蜥 Anolis OS 7.9 一键安装 Oracle 19C（19.23）单机版过程（全程无需人工干预）：（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
# 前言
Oracle 一键安装脚本，演示 龙蜥 Anolis 7.9 一键安装 Oracle 19C 单机（全程无需人工干预）。
...
-rwx------ 1 root root 3059705302 May  6 10:07 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     201804 May  6 10:07 OracleShellInstall
-rwx------ 1 root root  127475677 May  6 10:06 p36199232_190000_Linux-x86-64.zip
-rwx------ 1 root root 1856311021 May  6 10:07 p36233263_190000_Linux-x86-64.zip
-rwx------ 1 root root  133535622 May  6 10:06 p6880880_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240506101138.log                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 227 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1487 秒)
正在创建监听......已完成 (耗时: 14 秒)
正在创建数据库......已完成 (耗时: 1505 秒)
正在优化数据库......已完成 (耗时: 18 秒)

恭喜！Oracle 单机安装成功 (耗时: 3332 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 06-MAY-2024 11:12:06
...
Start Date                06-MAY-2024 11:10:21
...
SQL*Plus: Release 19.0.0.0.0 - Production on Mon May 6 11:12:13 2024
Version 19.23.0.0.0
...
sys@LUCIFER 2024-05-06 11:12:14> show parameter name
