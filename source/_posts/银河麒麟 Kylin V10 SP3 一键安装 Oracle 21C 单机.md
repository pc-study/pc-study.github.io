---
title: 银河麒麟 Kylin V10 SP3 一键安装 Oracle 21C 单机
date: 2024-05-24 15:44:55
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793910943792582656
---

# 前言

Oracle 一键安装脚本，演示 麒麟 Kylin V10 SP3 一键安装 Oracle 21C 单机（全程无需人工干预）。
...
# 安装包存放在 /soft 目录下
[root@kylin soft]# ll
-rwx------ 1 root root 628686848  2月 26 14:09 LINUX.X64_213000_db_home.zip
-rwxr-xr-x 1 root root    195976  2月 26 14:09 OracleShellInstall
-rwx------ 1 root root 760980000  2月 26 14:09 p36352352_210000_Linux-x86-64.zip
-rwx------ 1 root root 127629034  2月 26 14:09 p6880880_210000_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240226141017.log）                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1780 秒)
正在创建监听......已完成 (耗时: 4 秒)
正在创建数据库......已完成 (耗时: 1972 秒)
正在优化数据库......已完成 (耗时: 22 秒)

恭喜！Oracle 单机安装成功 (耗时: 4166 秒)，现在是否重启主机：[Y/N] Y
...
```bash
[root@kylin:/root]$ cat /etc/os-release 
NAME="Kylin Linux Advanced Server"
VERSION="V10 (Lance)"
ID="kylin"
VERSION_ID="V10"
...
SQL*Plus: Release 21.0.0.0.0 - Production on Mon Feb 26 15:25:05 2024
Version 21.14.0.0.0
...
sys@LUCIFER 2024-02-26 15:25:08> show parameter name
