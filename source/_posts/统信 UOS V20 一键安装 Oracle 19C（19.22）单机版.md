---
title: 统信 UOS V20 一键安装 Oracle 19C（19.22）单机版
date: 2024-03-29 13:49:45
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1773564096011669504
---

**Oracle 一键安装脚本，演示 统信 UOS V20 一键安装 Oracle 19C（19.22）单机版过程（全程无需人工干预）：（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
- 2、配置好网络
- 3、挂载本地 ISO 镜像源
- 4、上传必须软件安装包（安装基础包，补丁包：35685663、35574075、6880880）
- 5、上传一键安装脚本：OracleShellInstall

**✨ 偷懒可以直接下载本文安装包合集：[统信 UOS V20 安装 Oracle 19C（19.22）单机版安装包合集（包含补丁！！！）](https://www.modb.pro/doc/127404)**
...
[root@uosv20 ~]# cd /soft/
[root@uosv20 soft]# ll
-rwx------ 1 root root 3059705302  3月 28 18:28 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     170166  3月 28 18:26 OracleShellInstall
-rwx------ 1 root root  127451050  3月 28 18:27 p35926646_190000_Linux-x86-64.zip
-rwx------ 1 root root 1817908992  3月 28 18:27 p35943157_190000_Linux-x86-64.zip
-rwx------ 1 root root  127774864  3月 28 18:27 p6880880_190000_Linux-x86-64.zip
...
3月 28 18:29:38 uosv20 systemd[1]: Stopping firewalld - dynamic firewall daemon...
3月 28 18:29:40 uosv20 systemd[1]: firewalld.service: Succeeded.
3月 28 18:29:40 uosv20 systemd[1]: Stopped firewalld - dynamic firewall daemon.
...
3月 28 18:30:43 uosv20 avahi-daemon[1073]: No service file found in /etc/avahi/services.
3月 28 18:30:43 uosv20 avahi-daemon[1073]: Files changed, reloading.
3月 28 18:30:43 uosv20 avahi-daemon[1073]: No service file found in /etc/avahi/services.
3月 28 18:30:45 uosv20 avahi-daemon[1073]: Got SIGTERM, quitting.
3月 28 18:30:45 uosv20 avahi-daemon[1073]: Leaving mDNS multicast group on interface ens33.IPv6 with address fe80::88f9:eb9b:43bc:6d1c.
3月 28 18:30:45 uosv20 systemd[1]: Stopping Avahi mDNS/DNS-SD Stack...
3月 28 18:30:45 uosv20 avahi-daemon[1073]: Leaving mDNS multicast group on interface ens33.IPv4 with address 192.168.6.141.
3月 28 18:30:45 uosv20 avahi-daemon[1073]: avahi-daemon 0.7 exiting.
3月 28 18:30:45 uosv20 systemd[1]: avahi-daemon.service: Succeeded.
3月 28 18:30:45 uosv20 systemd[1]: Stopped Avahi mDNS/DNS-SD Stack.
...
The log can be found at: /tmp/InstallActions2024-03-28_06-33-29PM/installerPatchActions_2024-03-28_06-33-29PM.log
Launching Oracle Database Setup Wizard...

[WARNING] [INS-13014] Target environment does not meet some optional requirements.
   CAUSE: Some of the optional prerequisites are not met. See logs for details. installActions2024-03-28_06-33-29PM.log
   ACTION: Identify the list of failed prerequisite checks from the log: installActions2024-03-28_06-33-29PM.log. Then either from the log file or from installation manual find the appropriate configuration to meet the prerequisites and fix it manually.
The response file for this session can be found at:
 /u01/app/oracle/product/19.3.0/db/install/response/db_2024-03-28_06-33-29PM.rsp

You can find the log of this install session at:
 /tmp/InstallActions2024-03-28_06-33-29PM/installActions2024-03-28_06-33-29PM.log
...
Moved the install session logs to:
 /u01/app/oraInventory/logs/InstallActions2024-03-28_06-33-29PM
...
Check /u01/app/oracle/product/19.3.0/db/install/root_uosv20_2024-03-28_18-59-46-687369635.log for the output of root script
...
Log file location : /u01/app/oracle/product/19.3.0/db/cfgtoollogs/opatch/opatch2024-03-28_18-59-52PM_1.log
...
OPatch version    : 12.2.0.1.40
OUI version       : 12.2.0.7.0
Log file location : /u01/app/oracle/product/19.3.0/db/cfgtoollogs/opatch/opatch2024-03-28_19-00-10PM_1.log
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 28-MAR-2024 19:02:50
...
Start Date                28-MAR-2024 19:02:39
...
---------- ---------- ------------------------------------------------------------------------------------------------------------------------ ----------
         ...
         1         11 /oradata/LUCIFER/onlinelog/o1_mf_11_m0bofcj1_.log                                                                               100
         1         12 /oradata/LUCIFER/onlinelog/o1_mf_12_m0bofcol_.log                                                                               100
         1         13 /oradata/LUCIFER/onlinelog/o1_mf_13_m0bofcry_.log                                                                               100
         1         14 /oradata/LUCIFER/onlinelog/o1_mf_14_m0bofcwo_.log                                                                               100
         1         15 /oradata/LUCIFER/onlinelog/o1_mf_15_m0bofd2p_.log                                                                               100
