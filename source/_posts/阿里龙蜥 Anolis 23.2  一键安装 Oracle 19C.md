---
title: 阿里龙蜥 Anolis 23.2  一键安装 Oracle 19C
date: 2025-03-05 10:54:58
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1897118608610832384
---

>大家好，这里是 **Lucifer三思而后行**，专注于提升数据库运维效率。

## 前言
Oracle 一键安装脚本，演示 龙蜥 Anolis 23.2 一键安装 Oracle 19C 单机（全程无需人工干预）。
...
-rwx------. 1 root root 3059705302  3月 4日 15:30 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root     245268  3月 4日 15:30 OracleShellInstall
-rwx------. 1 root root     321590  3月 4日 15:30 rlwrap-0.44.tar.gz
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20250304153312.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 122 秒)
正在创建监听......已完成 (耗时: 3 秒)
正在创建数据库......已完成 (耗时: 659 秒)
正在优化数据库......已完成 (耗时: 35 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 1030 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 19.0.0.0.0 - Production on Wed Mar 5 10:53:43 2025
Version 19.3.0.0.0
