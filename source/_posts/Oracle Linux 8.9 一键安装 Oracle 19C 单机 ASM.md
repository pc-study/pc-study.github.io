---
title: Oracle Linux 8.9 一键安装 Oracle 19C 单机 ASM
date: 2024-05-24 17:26:12
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793936447476158464
---

# 前言

Oracle 一键安装脚本，演示 Oracle Linux 8.9 一键安装 Oracle 19C 单机 ASM （19.23）过程（全程无需人工干预）。
...
-rwxr-xr-x. 1 root root     195976 Apr 22 09:25 OracleShellInstall
-rwx------. 1 root root  127475677 Apr 22 09:23 p36199232_190000_Linux-x86-64.zip
-rwx------. 1 root root 3411816300 Apr 22 09:24 p36233126_190000_Linux-x86-64.zip
-rwx------. 1 root root  133535622 Apr 22 09:23 p6880880_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240422092744.log）                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 222 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 175 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 2493 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 2898 秒)
正在创建数据库......已完成 (耗时: 1985 秒)
正在优化数据库......已完成 (耗时: 164 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 8070 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 19.0.0.0.0 - Production on Mon Apr 22 12:00:00 2024
Version 19.23.0.0.0
...
sys@LUCIFER 2024-04-22 12:00:00> show parameter name
...
sys@LUCIFER 2024-04-22 12:00:03> select instance_name,status from gv$instance;
