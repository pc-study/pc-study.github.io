---
title: 《零基础安装 Oracle 数据库》单机ASM系列 1️⃣ 一键快速安装 Oracle 11GR2 数据库
date: 2021-08-22 00:08:48
tags: [oracle安装,玩转 vagrant]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/101861
---
...
下载好之后，将 Oracle 安装包拷贝到项目中的 `singleasm_db/software/11204` 目录下，以下 4 个文件必须全部上传，少一个都不行。

![](https://oss-emcsprod-public.modb.pro/image/editor/20210822-77a09458-5a7d-4d31-beed-0febdbca9f10.png)

<font color='red'>**📢 注意：**</font> 项目 `singleasm_db/software/11204` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 <font color='red'>**失败**</font>！
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20210822-3f5ebd04-6cd0-4848-8acf-79617a73fea9.png)
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20210822-773d448b-b9cd-4b01-b793-0bc79102c7f7.png)
