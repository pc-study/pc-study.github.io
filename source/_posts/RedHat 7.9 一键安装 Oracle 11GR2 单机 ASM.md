---
title: RedHat 7.9 一键安装 Oracle 11GR2 单机 ASM
date: 2024-05-24 16:03:01
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793915540619743232
---

# 前言

Oracle 一键安装脚本，演示 RedHat 7.9 一键安装 Oracle 11GR2 单机 ASM（231017）过程（全程无需人工干预）。
...
OracleShellInstall 开始安装，安装过程可查看日志： /soft/print_ora_install_20240426164720.log                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 49 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1133 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1022 秒)
正在创建数据库......已完成 (耗时: 824 秒)
正在优化数据库......已完成 (耗时: 25 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 3215 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 11.2.0.4.0 Production on Fri Apr 26 17:48:28 2024
...
sys@LUCIFER 2024-04-26 17:48:28> show parameter name
