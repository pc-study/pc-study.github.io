---
title: 统信 UOS V20 1070(a) 一键安装 Oracle 19C 单机
date: 2024-05-25 02:08:01
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1794067752356499456
---

# 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1070(a) 一键安装 Oracle 19C 单机（全程无需人工干预）。
...
-rwx------ 1 root root 3059705302  5月 24 14:07 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     208290  5月 24 14:05 OracleShellInstall
-rwx------ 1 root root  127475677  5月 24 14:06 p36199232_190000_Linux-x86-64.zip
-rwx------ 1 root root 1856311021  5月 24 14:07 p36233263_190000_Linux-x86-64.zip
-rwx------ 1 root root  133535622  5月 24 14:06 p6880880_190000_Linux-x86-64.zip
-rwx------ 1 root root     321590  5月 24 14:06 rlwrap-0.44.tar.gz
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240525000822.log            
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 150 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1447 秒)
正在创建监听......已完成 (耗时: 9 秒)
正在创建数据库......已完成 (耗时: 1578 秒)
正在优化数据库......已完成 (耗时: 24 秒)

恭喜！Oracle 单机安装成功 (耗时: 3287 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 25-MAY-2024 02:02:52
...
Start Date                25-MAY-2024 01:38:42
...
SQL*Plus: Release 19.0.0.0.0 - Production on Sat May 25 02:02:54 2024
Version 19.23.0.0.0
...
sys@LUCIFER 2024-05-25 02:02:54> show parameter name
