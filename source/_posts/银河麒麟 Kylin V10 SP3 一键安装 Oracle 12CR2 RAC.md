...
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793910233696915456
---
...
## Oracle 12CR2 基础版官方默认必须安装 GIMR 组件（OCR 磁盘组至少需要 50 G 空间），建议增加 OCR 磁盘空间或者安装 Grid PSU 补丁号为 12.2.0.1.190115(28828733) 之后的版本!
## 可参考：Oracle 12CR2 RAC 基础版安装要求说明（GIMR） https://github.com/DBAutoTask/OracleShellInstall/issues/15
## 节点一
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240623161855.log
...
正在配置 RAC 所有节点互信......已完成 (耗时: 14 秒)
正在解压 Grid 安装包以及补丁......已完成 (耗时: 88 秒)
正在解压 Oracle 软件以及补丁......已完成 (耗时: 87 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 2847 秒)
正在创建 ASM 磁盘组......已完成 (耗时: 23 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 635 秒)
正在创建数据库......已完成 (耗时: 590 秒)
正在优化数据库......已完成 (耗时: 20 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 4527 秒)，现在是否重启主机：[Y/N] Y
...
此 Oracle 主目录中未安装任何中间补丁程序 "/u01/app/12.2.0/grid".
...
MOUNTED  EXTERN  N         512             512   4096  4194304     20480    18304                0           18304              0             N  DATA/
MOUNTED  EXTERN  N         512             512   4096  4194304     51200    17172                0           17172              0             Y  OCR/
```
查看 Oracle 版本以及补丁：
```bash
...
此 Oracle 主目录中未安装任何中间补丁程序 "/u01/app/oracle/product/12.2.0/db".
