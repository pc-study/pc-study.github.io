---
title: 全网首发！红帽 RHEL 10.0 一键安装 Oracle 11GR2，硬核！
date: 2024-11-21 21:16:59
tags: [墨力计划,oracle一键安装脚本]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1859586649961803776
---
...
# 前言
前文成功演示了 **[RedHat 10.0 一键安装 Oracle 19C 单机](https://www.modb.pro/db/1859573626224259072)**，这篇接着干 11GR2 版本，玩就是了。

本文演示使用 Oracle 一键安装脚本在 RedHat 10.0 上一键安装 Oracle 11GR2 单机。
...
# 安装包存放在 /soft 目录下
[root@rhel10 soft]# ll
-rwxr-xr-x. 1 root root     243567 Nov 22 01:24 OracleShellInstall
-rwx------. 1 root root 1395582860 Nov 22 01:21 p13390677_112040_Linux-x86-64_1of7.zip
-rwx------. 1 root root 1151304589 Nov 22 01:22 p13390677_112040_Linux-x86-64_2of7.zip
-rw-r--r--. 1 root root     321590 Nov 22 01:14 rlwrap-0.44.tar.gz
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20241122012711.log
...
正在安装依赖包......已完成 (耗时: 116 秒)
正在配置 Swap......已完成 (耗时: 16 秒)
正在禁用防火墙......已完成 (耗时: 1 秒)
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 33 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 192 秒)
正在创建监听......已完成 (耗时: 2 秒)
正在创建数据库......已完成 (耗时: 184 秒)
正在优化数据库......已完成 (耗时: 6 秒)s

恭喜！Oracle 一键安装执行完成 (耗时: 582 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 11.2.0.4.0 - Production on 22-NOV-2024 05:13:34
...
Start Date                22-NOV-2024 05:12:47
...
SQL*Plus: Release 11.2.0.4.0 Production on Fri Nov 22 05:13:53 2024
...
# 写在最后
看来脚本的适配性还是很强的，RHEL 10 轻轻松松安装 Oracle 单机，马上下一篇就是测试 RAC 适配！
