---
title: SUSE 15 SP5 一键安装 Oracle 19C（19.22）单机版
date: 2024-03-26 17:22:58
tags: [墨力计划,oracle 19c,oracle一键安装脚本]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1772452639086809088
---

# 前言
**Oracle 一键安装脚本，演示 SUSE 15 SP5 一键安装 Oracle 19C（19.22）单机版过程（全程无需人工干预）：（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
**✨ 偷懒可以直接下载本文安装包合集：[SUSE 15 SP5 一键安装 Oracle 19C（19.22）单机版安装包合集（包含补丁！！！）](https://www.modb.pro/doc/127404)**
...
# 安装包存放在 /soft 目录下
suse15:/soft # ll
-rwx------ 1 root root 3059705302 Mar 26 10:36 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     164307 Mar 26 10:40 OracleShellInstall
-rwx------ 1 root root  127451050 Mar 26 10:35 p35926646_190000_Linux-x86-64.zip
-rwx------ 1 root root 1817908992 Mar 26 10:36 p35943157_190000_Linux-x86-64.zip
-rwx------ 1 root root  127774864 Mar 26 10:35 p6880880_190000_Linux-x86-64.zip
...
Mar 26 16:24:01 suse15 systemd[1]: Stopping firewalld - dynamic firewall daemon...
Mar 26 16:24:03 suse15 systemd[1]: firewalld.service: Deactivated successfully.
Mar 26 16:24:03 suse15 systemd[1]: Stopped firewalld - dynamic firewall daemon.
...
The log can be found at: /tmp/InstallActions2024-03-26_04-28-37PM/installerPatchActions_2024-03-26_04-28-37PM.log
Launching Oracle Database Setup Wizard...

[WARNING] [INS-13014] Target environment does not meet some optional requirements.
   CAUSE: Some of the optional prerequisites are not met. See logs for details. installActions2024-03-26_04-28-37PM.log
   ACTION: Identify the list of failed prerequisite checks from the log: installActions2024-03-26_04-28-37PM.log. Then either from the log file or from installation manual find the appropriate configuration to meet the prerequisites and fix it manually.
The response file for this session can be found at:
 /u01/app/oracle/product/19.3.0/db/install/response/db_2024-03-26_04-28-37PM.rsp

You can find the log of this install session at:
 /tmp/InstallActions2024-03-26_04-28-37PM/installActions2024-03-26_04-28-37PM.log
...
Moved the install session logs to:
 /u01/app/oraInventory/logs/InstallActions2024-03-26_04-28-37PM
...
Check /u01/app/oracle/product/19.3.0/db/install/root_suse15_2024-03-26_16-54-28-422553014.log for the output of root script
...
Log file location : /u01/app/oracle/product/19.3.0/db/cfgtoollogs/opatch/opatch2024-03-26_16-54-33PM_1.log
...
OPatch version    : 12.2.0.1.40
OUI version       : 12.2.0.7.0
Log file location : /u01/app/oracle/product/19.3.0/db/cfgtoollogs/opatch/opatch2024-03-26_16-54-47PM_1.log
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 26-MAR-2024 16:57:14
...
Start Date                26-MAR-2024 16:57:13
...
---------- ---------- ------------------------------------------------------------------------------------------------------------------------ ----------
         ...
         1         11 /oradata/LUCIFER/onlinelog/o1_mf_11_m054w6yl_.log                                                       100
         1         12 /oradata/LUCIFER/onlinelog/o1_mf_12_m054w747_.log                                                       100
         1         13 /oradata/LUCIFER/onlinelog/o1_mf_13_m054w784_.log                                                       100
         1         14 /oradata/LUCIFER/onlinelog/o1_mf_14_m054w7dk_.log                                                       100
         1         15 /oradata/LUCIFER/onlinelog/o1_mf_15_m054w7k9_.log                                                       100
