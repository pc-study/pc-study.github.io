---
title: 阿里龙蜥 Anolis 7.9  一键安装 Oracle 12CR2 单机 ASM
date: 2024-05-24 17:05:28
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793931203413872640
---

# 前言

Oracle 一键安装脚本，演示龙蜥 Anolis 7.9 一键安装 Oracle 12CR2 单机 ASM（231017）过程（全程无需人工干预）。
...
-rwx------ 1 root root 2994687209 May  6 11:20 LINUX.X64_122010_grid_home.zip
-rwxr-xr-x 1 root root     201804 May  6 11:19 OracleShellInstall
-rwx------ 1 root root 2526745297 May  6 11:20 p35745595_122010_Linux-x86-64.zip
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240506113425.log                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 259 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 93 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1114 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1355 秒)
正在创建数据库......已完成 (耗时: 763 秒)
正在优化数据库......已完成 (耗时: 124 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 3792 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 12.2.0.1.0 Production on Mon May 6 13:05:18 2024
...
sys@LUCIFER 2024-05-06 13:05:18> show parameter name
