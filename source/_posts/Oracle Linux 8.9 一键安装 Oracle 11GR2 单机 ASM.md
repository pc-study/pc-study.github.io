---
title: Oracle Linux 8.9 一键安装 Oracle 11GR2 单机 ASM
date: 2024-05-24 17:22:03
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793935437593120768
---

# 前言

Oracle 一键安装脚本，演示 Oracle Linux 8.9 一键安装 Oracle 11GR2 单机 ASM （231017）过程（全程无需人工干预）。
...
在 Oracle Linux 8 安装 11GR2 单机 ASM 数据库，需要安装 19.14 版本之后的 Grid 软件补丁，然后再安装 11GR2 数据库：
...
-rwxr-xr-x. 1 root root     195976 Apr 22 14:04 OracleShellInstall
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240422140650.log）                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 64 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 2156 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 1216 秒)
正在创建数据库......已完成 (耗时: 1085 秒)
正在优化数据库......已完成 (耗时: 53 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 4896 秒)，现在是否重启主机：[Y/N] Y
...
SQL*Plus: Release 11.2.0.4.0 Production on Mon Apr 22 15:40:11 2024
...
sys@LUCIFER 2024-04-22 15:40:11> show parameter name
