---
title: 华为欧拉 openEuler 24.09 一键安装 Oracle 19C
date: 2025-03-04 13:44:14
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1896764273561448448
---

>大家好，这里是 **Lucifer三思而后行**，专注于提升数据库运维效率。

## 前言
Oracle 一键安装脚本，演示 openEuler 24.09 一键安装 Oracle 19C 单机过程（全程无需人工干预）。
...
-rwx------. 1 root root 3059705302  3月 4日 10:40 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root     244843  3月 4日 10:41 OracleShellInstall
-rwx------. 1 root root     321590  3月 4日 10:40 rlwrap-0.44.tar.gz
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20250304104219.log                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 78 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 117 秒)
正在创建监听......已完成 (耗时: 4 秒)
正在创建数据库......已完成 (耗时: 583 秒)
正在优化数据库......已完成 (耗时: 32 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 900 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 04-MAR-2025 12:58:24
...
Start Date                04-MAR-2025 12:22:20
...
SQL*Plus: Release 19.0.0.0.0 - Production on Tue Mar 4 12:58:33 2025
Version 19.3.0.0.0
