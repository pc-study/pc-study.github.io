...
date: 2024-05-24 15:43:59
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793910774132985856
---

# 前言
Oracle 一键安装脚本，演示 麒麟 Kylin V10 SP3 一键安装 Oracle 19C RAC 过程（全程无需人工干预）。
...
-rwx------ 1 root root 3059705302  6月 23 15:58 LINUX.X64_193000_db_home.zip
-rwx------ 1 root root 2889184573  6月 23 15:58 LINUX.X64_193000_grid_home.zip
-rwxr-xr-x 1 root root     226647  6月 23 15:57 OracleShellInstall
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240623161944.log                                                                                  
...
正在配置 RAC 其他节点信息......已完成 (耗时: 97 秒)
正在配置 RAC 所有节点互信......已完成 (耗时: 16 秒)
正在解压 Grid 安装包以及补丁......已完成 (耗时: 73 秒)
正在解压 Oracle 软件以及补丁......已完成 (耗时: 101 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1316 秒)
正在创建 ASM 磁盘组......已完成 (耗时: 27 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 573 秒)
正在创建数据库......已完成 (耗时: 1294 秒)
正在优化数据库......已完成 (耗时: 30 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 3625 秒)，现在是否重启主机：[Y/N] Y
...
ora.ASMNET1LSNR_ASM.lsnr(ora.asmgroup)
      ...
      2        ONLINE  ONLINE       kylinv10-02              STABLE
...
MOUNTED  EXTERN  N         512             512   4096  4194304     20480    17860                0           17860              0             N  DATA/
...
SQL*Plus: Release 19.0.0.0.0 - Production on Sun Jun 23 17:45:52 2024
Version 19.3.0.0.0
...
sys@LUCIFER 2024-06-23 17:45:52> select instance_name,status from gv$instance;
...
sys@LUCIFER 2024-06-23 17:46:02> show parameter name
