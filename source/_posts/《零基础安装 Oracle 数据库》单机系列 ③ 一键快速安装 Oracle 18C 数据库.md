---
title: 《零基础安装 Oracle 数据库》单机系列 ③ 一键快速安装 Oracle 18C 数据库
date: 2021-08-21 20:08:26
tags: [oracle安装,玩转 vagrant]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/101854
---
...
下载好之后，将 Oracle 安装包拷贝到项目中的 `single_db/software/18000` 目录下。

![](https://oss-emcsprod-public.modb.pro/image/editor/20210821-0c40cdcf-6ad9-460e-9b7e-d3e0b9e15885.png)

<font color='red'>**📢 注意：**</font> 项目 `single_db/software/18000` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 <font color='red'>**失败**</font>！
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20210821-910eba67-53ee-4a3b-92c3-3518fc2a7ea8.png)
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20210821-1087d53b-f170-4009-a83b-d53348b5fe73.png)
