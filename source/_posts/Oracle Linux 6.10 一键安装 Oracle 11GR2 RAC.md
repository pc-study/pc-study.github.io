---
title: Oracle Linux 6.10 一键安装 Oracle 11GR2 RAC
date: 2024-05-24 15:27:33
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1793906602780217344
---

# 前言

Oracle 一键安装脚本，演示 Oracle Linux 6.10 一键安装 Oracle 11GR2 RAC（231017）过程（全程无需人工干预）。
...
# 安装包存放在 /soft 目录下
[root@oel601 soft]# ll
-rwxr-xr-x. 1 root root     200600 Apr 29 13:01 OracleShellInstall
...
注意：本脚本仅用于新服务器上实施部署数据使用，严禁在已运行数据库的主机上执行，以免发生数据丢失或者损坏，造成不可挽回的损
...
OracleShellInstall 开始安装，安装过程可查看日志： /soft/print_ora_install_20240429125547.log
...
正在配置 RAC 其他节点信息......已完成 (耗时: 23 秒)
正在配置 RAC 所有节点互信......已完成 (耗时: 3 秒)
正在解压 Grid 安装包以及补丁......已完成 (耗时: 1 秒)
正在解压 Oracle 软件以及补丁......已完成 (耗时: 95 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 1947 秒)
正在创建 ASM 磁盘组......已完成 (耗时: 22 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 2476 秒)
正在创建数据库......已完成 (耗时: 780 秒)
正在优化数据库......已完成 (耗时: 175 秒)

恭喜！Oracle RAC 安装成功 (耗时: 5464 秒)，现在是否重启主机：[Y/N] Y
...
--------------------------------------------------------------------------------
ora.DATA.dg
               ONLINE  ONLINE       oel601
               ONLINE  ONLINE       oel602
ora.LISTENER.lsnr
               ONLINE  ONLINE       oel601
               ONLINE  ONLINE       oel602
ora.OCR.dg
               ...
               ONLINE  ONLINE       oel602
ora.asm
               ONLINE  ONLINE       oel601                   Started
               ONLINE  ONLINE       oel602                   Started
ora.gsd
               OFFLINE OFFLINE      oel601
               OFFLINE OFFLINE      oel602
ora.net1.network
               ONLINE  ONLINE       oel601
               ONLINE  ONLINE       oel602
ora.ons
...
ora.LISTENER_SCAN1.lsnr
      1        ONLINE  ONLINE       oel602
ora.cvu
      1        ONLINE  ONLINE       oel602
ora.lucifer.db
      1        ONLINE  ONLINE       oel601                   Open
      2        ONLINE  ONLINE       oel602                   Open
ora.oc4j
      1        ONLINE  ONLINE       oel602
ora.oel601.vip
      1        ONLINE  ONLINE       oel601
ora.oel602.vip
      1        ONLINE  ONLINE       oel602
ora.scan1.vip
      1        ONLINE  ONLINE       oel602
...
SQL*Plus: Release 11.2.0.4.0 Production on Mon Apr 29 17:29:48 2024
...
sys@LUCIFER 2024-04-29 17:29:48> show parameter name
...
sys@LUCIFER 2024-04-29 17:30:19> select instance_name,status from gv$instance;
