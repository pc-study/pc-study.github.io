---
title: Oracle Linux 8.9 一键安装 Oracle 19C RAC（19.22）
date: 2024-04-16 13:35:15
tags: [墨力计划]
author: 三笠丶
source: 墨天轮
source_url: https://www.modb.pro/db/1780107297712312320
---

# 前言
Oracle 一键安装脚本，演示 Oracle Linux 8.9 一键安装 Oracle 19C  RAC（19.22）过程（全程无需人工干预）。**（脚本包括 <font color='red'>ORALCE PSU/OJVM 等补丁自动安装</font>）**
...
# 安装包存放在 /soft 目录下
[root@oel01 soft]# ll
-rwx------. 1 root root 3059705302 Apr 16 09:53 LINUX.X64_193000_db_home.zip
...
-rwx------. 1 root root  127451050 Apr 16 09:52 p35926646_190000_Linux-x86-64.zip
...
OracleShellInstall 开始安装(安装过程可查看日志：/soft/print_ora_install_20240416101436.log）                                                                                  
...
正在安装 rlwrap 插件......已完成 (耗时: 15 秒)
正在配置用户环境变量......已完成 (耗时: 1 秒)
正在配置 RAC 其他节点信息......已完成 (耗时: 139 秒)
正在配置 RAC 所有节点互信......已完成 (耗时: 10 秒)
正在解压 Grid 安装包以及补丁......已完成 (耗时: 183 秒)
正在解压 Oracle 软件以及补丁......已完成 (耗时: 118 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 3229 秒)
正在创建 ASM 磁盘组......已完成 (耗时: 28 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 3025 秒)
正在创建数据库......已完成 (耗时: 2065 秒)
正在优化数据库......已完成 (耗时: 226 秒)

恭喜！Oracle RAC 安装成功 (耗时: 9160 秒)，现在是否重启主机：[Y/N] Y
...
查看 Oracle 版本以及补丁：
```bash
[oracle@oel02:/home/oracle]$ sqlplus -v

SQL*Plus: Release 19.0.0.0.0 - Production
Version 19.22.0.0.0

[oracle@oel02:/home/oracle]$ opatch lspatches
...
SQL*Plus: Release 19.0.0.0.0 - Production on Tue Apr 16 13:31:50 2024
Version 19.22.0.0.0
...
sys@LUCIFER 2024-04-16 13:31:53> show parameter name
...
sys@LUCIFER 2024-04-16 13:31:58> select instance_name,status from gv$instance;
